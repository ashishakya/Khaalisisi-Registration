...
<body style="background:#BC8F8F;">
	 <!-- <img src="emc.jpg" height="250px" width="250px" style="float: left;"> -->
	<form method="POST" onsubmit="return validate(this)" action="data.php" class="signup" style="background: #1DA364; border: solid 4px white;">
		<input  type="image" src="emc.jpg" alt="emc logo" height="30%" width="250px" style="float:left;"> 
		<input type="image" src="khaali sisi logo.jpg" alt="khaali sisi logo" height="30%" width="250px" style="float:right;">
		<br>
		...
		<table>
			<tr>
				<td>FIRST NAME</td>
				<td><input type="text" name="fname" placeholder="FIRST NAME" maxlength="20"></td>
			</tr>
			
			<tr>
				<td>LAST NAME</td>
				<td><input type="text" name="lname" placeholder="LAST NAME" maxlength="25"></td>
			</tr>
			
			<tr>
				<td>EMAIL</td>
				<td><input type="text" name="email" placeholder="EMAIL ADDRESS" maxlength="40"></td>
			</tr>
			...
			<tr>
				<td><input type="submit" name="submit" value="Submit" style="height: 25px;">
	...
	<center><h4 style="color:#0000CD; margin:0px; style="font-family: Courier New;"> <!-- &copy --> DEVELOPED BY ASHISH SHAKYA</h4></center>
</body>
</html>